...
export default function AttendanceMonthHeader({
  ...
  return (
    <div className={styles.header}>
      <PageTitle title="勤怠入力" description="対象月の予定、実績、休憩、交通費、申請状態を管理します。" />

      <div className={styles.monthControl}>
        <Input label="対象月" type="month" value={targetMonth} onChange={(event) => onChangeMonth(event.target.value)} className={styles.monthInput} />
